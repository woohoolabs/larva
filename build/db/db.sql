...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `students` (`id`, `first_name`, `last_name`, `birthday`, `gender`, `introduction`) VALUES (1, 'Krisztina', 'Kovács', NULL, 'FEMALE', 'Lórum ipse feltehetőleg nyúlós, de parás, hogy nem a süke rázár van beállítva. Ezért a handóság verpert, renségre metleni, a zselegástól a nyenyenyig gatos hoska büdörtömöt seblyézik ki.');
